...
max <- max %>% 
  ...
  # remove any concentrations about 1.5 million -- skew legend/colorscale to be uninterpretable
  filter(max < 850000)
...
plot <- plot %>% 
  layout(
    title = "Westport: Max Bacteria Concentration (850,000 max)",
