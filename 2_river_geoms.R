...
great <- read_sf(here("data","raw", "geoms", "great_brook.geojson"))
...
westport_geo <- rbind(westport_1, pussy_willow, stony_brook_1, stony_brook_2, west_branch, greens_farms, great)
...
westport_geo <- westport_geo %>% 
  ...
  mutate(river_name = case_when(
    ...
    #sasco
    ASSESSMENT_UNIT_NAME %in% c("Sasco Brook (Westport/Fairfield)-01",  "Sasco Brook (Westport/Fairfield)-02",
                                "Great Brook (Fairfield)-01", "Great Brook (Fairfield)-02") ~ "Sasco Brook",
